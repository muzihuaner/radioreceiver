    ...
    >
      ...
      >
        ...
        <div>
          调制方式:
          <b
            >${this.editorContent.scheme}${Vt(this.editorContent.scheme)?this.editorContent.stereo?" \u7ACB\u4F53\u58F0":" Mono":f}</b
          >${le(this.editorContent.scheme)?c`, 频宽:
        ...
        <div>
          ...
          >${he(this.editorContent.scheme)?c`, 静噪: <b>${this.editorContent.squelch}</b>`:f}
        </div>
