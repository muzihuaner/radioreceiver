  ...
  render() {
    ...
    >
      ...
      <div>
        ...
        <div class="cfgBlock">
          <span .hidden=${!modeParameters(this.scheme).hasBandwidth()}
          ...
          ><span .hidden=${!modeParameters(this.scheme).hasStereo()}>
            ...
            <span
              ...
              .hidden=${!modeParameters(this.scheme).hasStereo() ||
              !this.stereo}
              >${Icons.Stereo}</span
            ></span
          ><span .hidden=${!modeParameters(this.scheme).hasSquelch()}>
